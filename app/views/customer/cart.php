        ...
        <?php if (!empty($cart_items)): ?>
            ...
            <div class="cart-items-section">
                ...
                <div class="cart-table-header">
                    <div><input type="checkbox" id="selectAll" checked onchange="toggleAll(this)"
                ...
                <?php foreach ($cart_items as $item): ?>
                    <div class="cart-item-row" data-cart-id="<?= $item['ID_gio'] ?>">
                        <div style="display:flex;justify-content:center;">
                            <input type="checkbox" class="item-checkbox" data-id="<?= $item['ID_gio'] ?>"
                                data-price="<?= $item['Gia_tien'] ?>" checked onchange="calculateSummary()"
                                style="width:18px;height:18px;cursor:pointer;">
                        </div>
                        <div class="cart-item-info">
                            <img src="<?= asset('img/products/' . ($item['Hinh_anh'] ?? 'placeholder-product.png')) ?>"
                                class="cart-item-image" alt="<?= htmlspecialchars($item['Ten']) ?>">
                            <div class="cart-item-details">
                                ...
                                <div
                                    class="cart-item-stock <?= ($item['So_luong_ton'] > 10) ? 'stock-available' : 'stock-low' ?>">
                        ...
                        <div class="qty-control-modern">
                            ...
                            <input type="text" class="qty-input-modern" id="qty-<?= $item['ID_gio'] ?>"
                                value="<?= $item['So_luong'] ?>" data-max="<?= $item['So_luong_ton'] ?>" readonly>
                            <button class="qty-btn-modern" onclick="updateQty(<?= $item['ID_gio'] ?>, 1)">+</button>
                        </div>
            ...
            <div class="order-summary-section">
                ...
                <div class="total-section">
                    <div class="total-row">
                        ...
                        <div>
                            <div class="total-amount" id="total-amount"><?= number_format($total ?? 0, 0, ',', '.') ?>đ
                            </div>
...
<script>
    ...
    function calculateSummary() {
        ...
        checkboxes.forEach(cb => {
            ...
            const qtyInput = row.querySelector('.qty-input-modern');
